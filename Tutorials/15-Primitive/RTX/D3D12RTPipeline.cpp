...
ID3DBlobPtr CppDirectXRayTracing15::D3D12RTPipeline::compileLibrary(const WCHAR* filename, const WCHAR* targetString)
{
...
CppDirectXRayTracing15::RootSignatureDesc CppDirectXRayTracing15::D3D12RTPipeline::createRayGenRootDesc()
{
    // Create the root-signature
    CppDirectXRayTracing15::RootSignatureDesc desc;
    desc.range.resize(2);
    // gOutput
...
CppDirectXRayTracing15::DxilLibrary CppDirectXRayTracing15::D3D12RTPipeline::createDxilLibrary()
{
    // Compile the shader
