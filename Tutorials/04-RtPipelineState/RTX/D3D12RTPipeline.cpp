...
ID3DBlobPtr CppDirectXRayTracing04::D3D12RTPipeline::compileLibrary(const WCHAR* filename, const WCHAR* targetString)
{
...
CppDirectXRayTracing04::RootSignatureDesc CppDirectXRayTracing04::D3D12RTPipeline::createRayGenRootDesc()
{
...
CppDirectXRayTracing04::DxilLibrary CppDirectXRayTracing04::D3D12RTPipeline::createDxilLibrary()
{
    // Compile the shader
