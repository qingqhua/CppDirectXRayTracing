...
ID3DBlobPtr CppDirectXRayTracing05::D3D12RTPipeline::compileLibrary(const WCHAR* filename, const WCHAR* targetString)
{
...
CppDirectXRayTracing05::RootSignatureDesc CppDirectXRayTracing05::D3D12RTPipeline::createRayGenRootDesc()
{
...
CppDirectXRayTracing05::DxilLibrary CppDirectXRayTracing05::D3D12RTPipeline::createDxilLibrary()
{
    // Compile the shader
