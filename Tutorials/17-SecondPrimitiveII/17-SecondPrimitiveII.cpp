#pragma once
#include "17-SecondPrimitiveII.hpp"

void CppDirectXRayTracing17II::Application::InitDXR(HWND winHandle, uint32_t winWidth, uint32_t winHeight)
{
...
void CppDirectXRayTracing17II::Application::CreateAccelerationStructures()
{
    AccelerationStructureBuffers blas[2];

    blas[0] = mAccelerateStruct->createCubeBottomLevelAS(mpDevice, mpCmdList);
    //blas[0] = mAccelerateStruct->createPrimitiveBottomLevelAS(mpDevice, mpCmdList);
    blas[1] = mAccelerateStruct->createPrimitiveBottomLevelAS(mpDevice, mpCmdList);

    mpBottomLevelAS[0] = blas[0].pResult;
    mpBottomLevelAS[1] = blas[1].pResult;
...
void CppDirectXRayTracing17II::Application::CreateRtPipelineState()
{
    // Need 10 subobjects:
...
void CppDirectXRayTracing17II::Application::CreateShaderTable()
{
...
void CppDirectXRayTracing17II::Application::createShaderResources()
{
...
uint32_t CppDirectXRayTracing17II::Application::beginFrame()
{
...
void CppDirectXRayTracing17II::Application::endFrame(uint32_t rtvIndex)
{
...
// Callbacks
//////////////////////////////////////////////////////////////////////////
void CppDirectXRayTracing17II::Application::onLoad(HWND winHandle, uint32_t winWidth, uint32_t winHeight)
{
...
void CppDirectXRayTracing17II::Application::onFrameRender()
{
...
void CppDirectXRayTracing17II::Application::onShutdown()
{
...
{
    Framework::run(CppDirectXRayTracing17II::Application(), "Tutorial 17");
}
