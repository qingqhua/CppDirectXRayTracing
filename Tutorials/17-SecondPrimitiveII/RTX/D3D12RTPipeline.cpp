...
ID3DBlobPtr CppDirectXRayTracing17II::D3D12RTPipeline::compileLibrary(const WCHAR* filename, const WCHAR* targetString)
{
...
CppDirectXRayTracing17II::RootSignatureDesc CppDirectXRayTracing17II::D3D12RTPipeline::createRayGenRootDesc()
{
    // Create the root-signature
    CppDirectXRayTracing17II::RootSignatureDesc desc;
    desc.range.resize(2);
    // gOutput
...
CppDirectXRayTracing17II::RootSignatureDesc CppDirectXRayTracing17II::D3D12RTPipeline::createHitRootDesc()
{
...
CppDirectXRayTracing17II::DxilLibrary CppDirectXRayTracing17II::D3D12RTPipeline::createDxilLibrary()
{
    // Compile the shader
