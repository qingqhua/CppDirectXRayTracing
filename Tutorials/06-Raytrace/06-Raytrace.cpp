#pragma once
#include "06-RayTrace.hpp"

void CppDirectXRayTracing06::Application::InitDXR(HWND winHandle, uint32_t winWidth, uint32_t winHeight)
{
...
void CppDirectXRayTracing06::Application::CreateAccelerationStructures()
{
    mAccelerateStruct = D3D12AccelerationStructures();

    mpVertexBuffer = mAccelerateStruct.createTriangleVB(mpDevice);
    CppDirectXRayTracing06::AccelerationStructureBuffers bottomLevelBuffers = mAccelerateStruct.createBottomLevelAS(mpDevice, mpCmdList, mpVertexBuffer);
...
void CppDirectXRayTracing06::Application::CreateRtPipelineState()
{
    // Need 10 subobjects:
...
void CppDirectXRayTracing06::Application::CreateShaderTable()
{
...
void CppDirectXRayTracing06::Application::createShaderResources()
{
...
uint32_t CppDirectXRayTracing06::Application::beginFrame()
{
...
void CppDirectXRayTracing06::Application::endFrame(uint32_t rtvIndex)
{
...
// Callbacks
//////////////////////////////////////////////////////////////////////////
void CppDirectXRayTracing06::Application::onLoad(HWND winHandle, uint32_t winWidth, uint32_t winHeight)
{
...
void CppDirectXRayTracing06::Application::onFrameRender()
{
...
void CppDirectXRayTracing06::Application::onShutdown()
{
...
{
    Framework::run(CppDirectXRayTracing06::Application(), "Tutorial 04");
}
