...
ID3DBlobPtr CppDirectXRayTracing16::D3D12RTPipeline::compileLibrary(const WCHAR* filename, const WCHAR* targetString)
{
...
CppDirectXRayTracing16::RootSignatureDesc CppDirectXRayTracing16::D3D12RTPipeline::createRayGenRootDesc()
{
    // Create the root-signature
    CppDirectXRayTracing16::RootSignatureDesc desc;
    desc.range.resize(2);
    // gOutput
...
CppDirectXRayTracing16::RootSignatureDesc CppDirectXRayTracing16::D3D12RTPipeline::createHitRootDesc()
{
    // Create the root-signature
    CppDirectXRayTracing16::RootSignatureDesc desc;
    desc.range.resize(2);
...
CppDirectXRayTracing16::DxilLibrary CppDirectXRayTracing16::D3D12RTPipeline::createDxilLibrary()
{
    // Compile the shader
