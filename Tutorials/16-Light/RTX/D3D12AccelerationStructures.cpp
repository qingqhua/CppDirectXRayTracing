...
ID3D12ResourcePtr CppDirectXRayTracing16::D3D12AccelerationStructures::createBuffer(ID3D12Device5Ptr pDevice, uint64_t size, D3D12_RESOURCE_FLAGS flags, D3D12_RESOURCE_STATES initState, const D3D12_HEAP_PROPERTIES& heapProps)
{
...
ID3D12ResourcePtr CppDirectXRayTracing16::D3D12AccelerationStructures::createCubeVB(ID3D12Device5Ptr pDevice, int& vertexCount)
{
    vec3 vertices[] =
    {
...
ID3D12ResourcePtr CppDirectXRayTracing16::D3D12AccelerationStructures::createCubeIB(ID3D12Device5Ptr pDevice, int& indexCount)
{
    uint16 indices[] =
    {
    0, 1, 2,    // side 1
...
ID3D12ResourcePtr CppDirectXRayTracing16::D3D12AccelerationStructures::CreatePrimitiveVB(ID3D12Device5Ptr pDevice, int& vertexCount)
{
    // Vertex buffer
...
ID3D12ResourcePtr CppDirectXRayTracing16::D3D12AccelerationStructures::CreatePrimitiveIB(ID3D12Device5Ptr pDevice, int& indexCount)
{
...
CppDirectXRayTracing16::AccelerationStructureBuffers CppDirectXRayTracing16::D3D12AccelerationStructures::createBottomLevelAS(ID3D12Device5Ptr pDevice, ID3D12GraphicsCommandList4Ptr pCmdList, ID3D12ResourcePtr vBuffer, ID3D12ResourcePtr iBuffer, int vertexCount, int indexCount)
{
...
CppDirectXRayTracing16::AccelerationStructureBuffers CppDirectXRayTracing16::D3D12AccelerationStructures::createTopLevelAS(ID3D12Device5Ptr pDevice, ID3D12GraphicsCommandList4Ptr pCmdList, ID3D12ResourcePtr pBottomLevelAS, uint64_t& tlasSize)
{
...
int CppDirectXRayTracing16::D3D12AccelerationStructures::GetIndexCount()
{
    return static_cast<int>(mPrimitive.GetIndices().size());;
}

int CppDirectXRayTracing16::D3D12AccelerationStructures::GetVertexCount()
{
    return static_cast<int>(mPrimitive.GetVertices().size());
}
