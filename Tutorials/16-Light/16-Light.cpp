#pragma once
#include "16-Light.hpp"

void CppDirectXRayTracing16::Application::InitDXR(HWND winHandle, uint32_t winWidth, uint32_t winHeight)
{
...
void CppDirectXRayTracing16::Application::CreateAccelerationStructures()
{
    int vertexCount = 0;
    int indexCount = 0;
    ...
    CppDirectXRayTracing16::AccelerationStructureBuffers bottomLevelBuffers = mAccelerateStruct->createBottomLevelAS(mpDevice, mpCmdList, mpVertexBuffer, mpIndexBuffer,vertexCount,indexCount);
...
void CppDirectXRayTracing16::Application::CreateRtPipelineState()
{
    // Need 10 subobjects:
...
void CppDirectXRayTracing16::Application::CreateShaderTable()
{
...
void CppDirectXRayTracing16::Application::createShaderResources()
{
    ...
    mpDevice->CreateShaderResourceView(mpIndexBuffer, &indexsrvDesc, indexsrvHandle);
    ...
    mpDevice->CreateShaderResourceView(mpVertexBuffer, &vertexsrvDesc, vertexsrvHandle);
    
}

uint32_t CppDirectXRayTracing16::Application::beginFrame()
{
...
void CppDirectXRayTracing16::Application::endFrame(uint32_t rtvIndex)
{
...
// Callbacks
//////////////////////////////////////////////////////////////////////////
void CppDirectXRayTracing16::Application::onLoad(HWND winHandle, uint32_t winWidth, uint32_t winHeight)
{
...
void CppDirectXRayTracing16::Application::onFrameRender()
{
...
void CppDirectXRayTracing16::Application::onShutdown()
{
...
{
    Framework::run(CppDirectXRayTracing16::Application(), "Tutorial 15");
}
