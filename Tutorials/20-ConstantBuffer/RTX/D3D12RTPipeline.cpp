...
ID3DBlobPtr CppDirectXRayTracing20::D3D12RTPipeline::compileLibrary(const WCHAR* filename, const WCHAR* targetString)
{
...
CppDirectXRayTracing20::RootSignatureDesc CppDirectXRayTracing20::D3D12RTPipeline::createRayGenRootDesc()
{
    // Create the root-signature
    CppDirectXRayTracing20::RootSignatureDesc desc;
    desc.range.resize(3);
    // gOutput
...
CppDirectXRayTracing20::RootSignatureDesc CppDirectXRayTracing20::D3D12RTPipeline::createHitRootDesc()
{
...
CppDirectXRayTracing20::RootSignatureDesc CppDirectXRayTracing20::D3D12RTPipeline::CreateMissRootDesc()
{
    // Create the root-signature
    CppDirectXRayTracing20::RootSignatureDesc desc;
    desc.range.resize(1);
...
CppDirectXRayTracing20::DxilLibrary CppDirectXRayTracing20::D3D12RTPipeline::createDxilLibrary()
{
    // Compile the shader
