...
CppDirectXRayTracing19::AccelerationStructureBuffers CppDirectXRayTracing19::D3D12AccelerationStructures::createPrimitiveBottomLevelAS(ID3D12Device5Ptr pDevice, ID3D12GraphicsCommandList4Ptr pCmdList)
{
...
CppDirectXRayTracing19::AccelerationStructureBuffers CppDirectXRayTracing19::D3D12AccelerationStructures::createCubeBottomLevelAS(ID3D12Device5Ptr pDevice, ID3D12GraphicsCommandList4Ptr pCmdList)
{
...
CppDirectXRayTracing19::AccelerationStructureBuffers CppDirectXRayTracing19::D3D12AccelerationStructures::createBottomLevelAS(ID3D12Device5Ptr pDevice, ID3D12GraphicsCommandList4Ptr pCmdList, ID3D12ResourcePtr vBuffer, ID3D12ResourcePtr iBuffer, int vertexCount, int indexCount)
{
...
CppDirectXRayTracing19::AccelerationStructureBuffers CppDirectXRayTracing19::D3D12AccelerationStructures::createTopLevelAS(ID3D12Device5Ptr pDevice, ID3D12GraphicsCommandList4Ptr pCmdList, ID3D12ResourcePtr pBottomLevelAS[], uint64_t& tlasSize)
{
    ...
    transformation[0] = glm::translate(glm::mat4(1.0), glm::vec3(0.0f, -1.0f, 0.0f)); // Identity
    transformation[1] = translate(mat4(), vec3(0, 0.3, 0));
...
int CppDirectXRayTracing19::D3D12AccelerationStructures::GetVertexCount()
{
    return static_cast<int>(mSceneVertices.size());
}

int CppDirectXRayTracing19::D3D12AccelerationStructures::GetIndexCount()
{
    return static_cast<int>(mSceneIndices.size());
}


ID3D12ResourcePtr CppDirectXRayTracing19::D3D12AccelerationStructures::GetSphereIndexBuffer()
{
    return mSphereIndexBuffer;
}

ID3D12ResourcePtr CppDirectXRayTracing19::D3D12AccelerationStructures::GetSphereVertexBuffer()
{
