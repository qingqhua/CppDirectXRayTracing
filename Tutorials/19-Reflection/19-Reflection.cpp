...
void CppDirectXRayTracing19::Application::CreateGeometryBuffers(D3D12_CPU_DESCRIPTOR_HANDLE& srvHandle)
{
...
void CppDirectXRayTracing19::Application::CreateConstantBuffers(D3D12_CPU_DESCRIPTOR_HANDLE& srvHandle)
{
}
...
{
    Framework::run(CppDirectXRayTracing19::Application(), "Tutorial 17");
}
